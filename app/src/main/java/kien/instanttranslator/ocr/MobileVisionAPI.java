...
//            };
            ...
            for (int i = 0; i < items.size(); ++i)
            {
                ...
                RectF rectF_Block = new RectF(myItem.getBoundingBox());
                if(rectF_Block.contains(x,y))
                {
                    ...
                    for(int j=0;j<lineList.size();++j)
                    {
                        ...
                        RectF rectF_Line = new RectF(myItem.getBoundingBox());
                        if(rectF_Line.contains(x,y))
                        {
